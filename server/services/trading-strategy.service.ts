...
export class TradingStrategyService {
  ...
  evaluateScalpingStrategy(analysis: StockAnalysis): StrategyRecommendation {
    ...
    const technicalIndicators: TechnicalIndicators = {
      ...
      macdHist: latestData?.macdHist,
      bollingerUpper: latestData?.bollingerUpper,
      bollingerMiddle: latestData?.bollingerMiddle,
      bollingerLower: latestData?.bollingerLower,
      kdj_k: latestData?.kdj_k,
      kdj_d: latestData?.kdj_d,
      kdj_j: latestData?.kdj_j,
    };
